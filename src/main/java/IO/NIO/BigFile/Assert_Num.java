...
public class Assert_Num {
    ...
    int times=0;
    public void Assert_Num(String letter,String playNum,String commentNum,String collectNum,String shareNum,String fansNum,String videolastNumint) {
        switch (letter){
            case "A":
    ...
    private boolean getRes(String StrNum,int min,int max,String StrLastNum) {
        times++;
        boolean res=false;
