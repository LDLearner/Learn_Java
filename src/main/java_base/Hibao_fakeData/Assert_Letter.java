...
public class Assert_Letter {
    ...
    public static void ArrListAdd(ArrayList Arr, String A) {
        Arr.add(A);
    }

    public static void ArrListAdd(ArrayList Arr, String A, String B) {
        Arr.add(A);
        Arr.add(B);
    }

    public static void ArrListAdd(ArrayList Arr, String A, String B, String C) {
        Arr.add(A);
        Arr.add(B);
        Arr.add(C);
    }

    public static void ArrListAdd(ArrayList Arr, String A, String B, String C, String D) {
        Arr.add(A);
        Arr.add(B);
        Arr.add(C);
        Arr.add(D);
